...
class pushmessage{
    ...
    public $androidAuthKey = "AIzaSyDmbBpBmsIAs_J1P7sNpZLrqhT1GmQQvBY";
    ...
    private function sendMessageAndroid($registration_id, $params) {
            $this->androidAuthKey = "AIzaSyDmbBpBmsIAs_J1P7sNpZLrqhT1GmQQvBY";//Auth Key Herer
