            ...
            <tr>
                <td align="center" valign="top" style="height:100%;margin:0;padding:0;width:100%;border-top:0">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse">
                                                    ...
                                                    <td valign="top" style="padding-top:9px">
                                                        ...
                                                        <table align="left" border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td valign="top"
                                                                    style="padding-top:0;padding-right:18px;padding-bottom:9px;padding-left:18px;word-break:break-word;color:#656565;font-family:Helvetica;font-size:12px;line-height:150%;text-align:left">

                                                                    <div style="text-align:center"><span
                                                                                style="font-size:24px"><strong>Recommendations For {{$client->name}}</strong></span></div>
                                                            ...
                                                            <tr>
                                                                <td valign="top"
                                                                    ...
                                                                    <img align="center" alt=""
                                                                         src="https://ci6.googleusercontent.com/proxy/DmzlWaZdWDFCwWqChmEwUTpsCGhJgwVZmwwmVn8SC_AztoDtJOBCCKgI0HdvG3G_GtXeRpsEJPpStK5COHQcvk5M_za4R5oJcaRrOzzpzyz2xxSUXEHB-I1ZRE0ipwx1LoJi5n4Vc_Q1iEysITM68FbQzXLYgIjCGrZkigw=s0-d-e1-ft#https://gallery.mailchimp.com/5dd95e764e130354f0138aac0/images/a9e93c00-e947-444e-88a2-f96951a0f2a8.jpg"
                                                                         width="564"
                                                                         style="max-width:1667px;padding-bottom:0;display:inline!important;vertical-align:bottom;border:0;min-height:auto;outline:none;text-decoration:none"
                                                                         class="CToWUd a6T" tabindex="0">
                                                                    <div class="a6S" dir="ltr"
                                                                         style="opacity: 0.01; left: 595.5px; top: 252.547px;">
                                                                        <div id=":2pt"
                                                    ...
                                                    <td valign="top" style="padding-top:9px">
                                                        ...
                                                        <table align="left" border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td valign="top"
                                                                    style="padding-top:0;padding-right:18px;padding-bottom:9px;padding-left:18px;word-break:break-word;color:#202020;font-family:Helvetica;font-size:16px;line-height:150%;text-align:left">
                                                    ...
                                                    <td valign="top" style="padding-top:9px">
                                                        ...
                                                        <table align="left" border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td valign="top"
                                                                    style="padding:0px 18px 9px;font-weight:bold;line-height:125%;word-break:break-word;color:#202020;font-family:Helvetica;font-size:16px;text-align:left">

                                                                    <span style="font-size:20px"><strong>Must have Products in your Wardrobe</strong></span>
                                                                </td>
                                                            </tr>
                                                            </tbody>
                                                        </table>
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                                ...
                                                <tr>
                                                    <td style="min-width:100%;padding:0px 18px">
                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                                               style="min-width:100%;border-top:2px inset #eaeaea;border-collapse:collapse">
                                                            <tbody>
                                                            <tr>
                                                                <td>
                                                                    <span></span>
                        ...
                        <tr>
                            <td align="center" valign="top"
                                style="background-color:#ffffff;border-top:0;border-bottom:0;padding-top:0;padding-bottom:0">
                                <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                       style="border-collapse:collapse;max-width:600px!important">
                                    <tbody>
                                    <tr>
                                                        ...
                                                        <table align="left" border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td valign="top"
                                                                    ...
                                                                    <em>Copyright © *2016* *IStyleYou*, All rights
                                                                        reserved.</em><br>
                                                                    <br>
                                                                    ...
                                                                    *stylist@istyleyou.in*<br>
                                                                    ...
                                                                    You can <a
                                                                        ...
                                                                        your preferences</a> or <a
                                                                            style="color:#656565;font-weight:normal;text-decoration:underline">unsubscribe
                                                                        from this list</a><br>
                                                                    <br>
