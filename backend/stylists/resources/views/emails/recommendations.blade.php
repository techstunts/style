                                                            ...
                                                            <tr>
                                                                ...
                                                                <td valign="top"
                                                                    ...
                                                                    <div style="text-align:center"><span
                                                                                style="font-size:24px"><strong>Recommendations For {{$client_first_name}}</strong></span></div>
                                                        ...
                                                        <table align="left" width="100%" border="0" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                <td valign="top"
                                                                    ...
                                                                    <img align="center" src="{{$banner_image_path}}"
                                                                         width="564"
                                                        ...
                                                        <table align="left" border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td valign="top"
                                                                    ...
                                                                    <strong>Hey {{$client_first_name}},</strong><br>
                                                                    <br>
                                                                    {{$custom_message}}
                                                                </td>
                                                            </tr>
                                                        ...
                                                        <table align="left" border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td valign="top"
                                                                    ...
                                                                    <span style="font-size:20px"><strong>{{$product_list_heading}}</strong></span>
                                                                </td>
                                                            </tr>
                                                            </tbody>
                                                        </table>
