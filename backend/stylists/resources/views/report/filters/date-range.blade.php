...
<br/>
<input type="text" id="{{$attributeKey}}_from_date" name="{{$attributeKey}}['from_date']" value="" placeholder="From Date" class="report-date-range" data-attributename="{{$attribute->getDisplayName()}}" data-attributekey="{{$attributeKey}}" >
To
