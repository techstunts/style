<form method="POST" action="{!! url('/update/bulkUpdate') !!}">
    {!! csrf_field() !!}
    ...
    <input type="submit" id="update_selected" name="update_selected" value="Update Selected" action_url="{!! url('/update/selectedProducts') !!}" />
