        ...
        <div class="col s2" style="border-right:1px solid #3d464d;height: 60px">
            <ul>
                ...
                <ul id="dropdown1" class="dropdown-content">
                    ...
                    <li><a href="/collection/create">Collection</a></li>
                    <li><a href="/look/create">Look</a></li>
                    <li><a href="/tip/create">Tip</a></li>
                </ul>
            </ul>
        </div>
            <div class="col s3">
                <ul>
                    ...
                    <ul id="dropdown2" class="dropdown-content">
                        <li><a href="{!! url('look/list/' . Auth::user()->id) !!}">My Looks</a></li>
                        <li><a href="{!! url('tip/list/' . Auth::user()->id) !!}">My Tips</a></li>
                        <li><a href="{!! url('collection/list/' . Auth::user()->id) !!}">My Collections</a></li>
                        <li class="divider"></li>
